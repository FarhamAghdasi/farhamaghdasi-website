...
const BlogContent = ({ post, fetchBlogPost }) => { // دریافت prop post و fetchBlogPost
    if (!post) {
    ...
    const handleCommentSubmit = async (e) => {
        ...
        try {
            await fetch(`https://farhamaghdasi.ir/api/wp-json/wp/v2/comments`, {
                method: 'POST',
                headers: {
            ...
            // پس از ارسال کامنت، پست را دوباره بارگذاری کنید
            fetchBlogPost(); // بارگذاری مجدد پست برای دریافت نظرات جدید
        } catch (error) {
                            ...
                            <div className="info d-flex mt-40 align-items-center">
                                ...
                                <div className="right-info ml-auto">
                                    <div>
                                        ...
                                        <span className="opacity-7">{post.comments.length} Comments</span> {/* تعداد نظرات */}
                                    </div>
                                </div>
                            </div>
                        </div>
